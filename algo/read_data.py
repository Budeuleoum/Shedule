...
def read_slots_table(file_name = '../data/Data.xlsx'):
...
def read_teachers_schedule(file_name = '../data/Data.xlsx'):
...
def read_places_schedule(file_name = '../data/Data.xlsx'):
...
def read_groups_schedule(file_name = '../data/Data.xlsx'):
...
def read_teachers(file_name = '../data/Data.xlsx'):
...
def read_places(file_name = '../data/Data.xlsx'):
...
def read_subjects(file_name = '../data/Data.xlsx'):
...
def read_groups(file_name = '../data/Data.xlsx'):
...
def read_all_data(file_name = '../data/Data.xlsx'):
